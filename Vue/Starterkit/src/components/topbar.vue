  ...
  <header id="page-topbar">
    <div class="navbar-header">
      <div class="d-flex">
        ...
        <BButton @click="toggleMenu" type="button" size="sm" variant="none" class="px-3 font-size-16 header-item waves-effect vertical-menu-btn"
      ...
      <div class="d-flex">
        <BDropdown variant="white" class="d-inline-block d-lg-none ms-2" toggle-class="header-item noti-icon" right
        ...
        <BDropdown variant="white" class="d-none d-lg-inline-block ms-1" toggle-class="header-item noti-icon" right
        ...
        <div class="dropdown d-none d-lg-inline-block ms-1">
          <BButton variant="button" class="btn header-item noti-icon waves-effect" @click="initFullScreen">
        ...
        <div class="dropdown d-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
            ...
            <simplebar style="max-height: 230px;">
              <BLink href="javascript:void(0);" class="text-dark notification-item">
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mb-1">{{ $t("navbar.dropdown.notification.order.title") }}</h6>
                    <div class="font-size-12 text-muted">
                      <p class="mb-1">{{ $t("navbar.dropdown.notification.order.text") }}</p>
                      <p class="mb-0"><i class="mdi mdi-clock-outline"></i> {{ $t("navbar.dropdown.notification.order.time") }} </p>
                    </div>
                  </div>
                </div>
              </BLink>
              <BLink href="javascript:void(0);" class="text-dark notification-item">
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mb-1">{{ $t("navbar.dropdown.notification.james.title") }}</h6>
                    <div class="font-size-12 text-muted">
                      <p class="mb-1">{{ $t("navbar.dropdown.notification.james.text") }}</p>
                      <p class="mb-0"><i class="mdi mdi-clock-outline"></i> {{ $t("navbar.dropdown.notification.james.time") }}</p>
                    </div>
                  </div>
                </div>
              </BLink>
              <BLink href="javascript:void(0);" class="text-dark notification-item">
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mb-1">{{ $t("navbar.dropdown.notification.item.title") }}</h6>
                    <div class="font-size-12 text-muted">
                      <p class="mb-1">{{ $t("navbar.dropdown.notification.item.text") }}</p>
                      <p class="mb-0"><i class="mdi mdi-clock-outline"></i> {{ $t("navbar.dropdown.notification.item.time") }}</p>
                    </div>
                  </div>
                </div>
              </BLink>
              <BLink href="javascript:void(0);" class="text-dark notification-item">
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mb-1">{{ $t("navbar.dropdown.notification.salena.title") }}</h6>
                    <div class="font-size-12 text-muted">
                      <p class="mb-1">{{ $t("navbar.dropdown.notification.salena.text") }}</p>
                      <p class="mb-0"><i class="mdi mdi-clock-outline"></i> {{ $t("navbar.dropdown.notification.salena.time") }}</p>
                    </div>
                  </div>
                </div>
              </BLink>
        ...
        <div class="dropdown d-inline-block">
          <BButton variant="button" class="btn header-item noti-icon right-bar-toggle toggle-right"
