                ...
                <div class="p-2 mt-4">
                  ...
                  <BForm @submit.prevent="tryToLogIn">
                    <BFormGroup id="input-group-1" class="mb-3" label="Username" label-for="input-1">
                      <BFormInput id="input-1" v-model="email" type="text" placeholder="Enter email" :class="{ 'is-invalid': submitted && v$.email.$error }"></BFormInput>
                    ...
                    <div class="mt-3 text-end">
                      <BButton type="submit" variant="primary" class="w-sm">Log In</BButton>
                    </div>
