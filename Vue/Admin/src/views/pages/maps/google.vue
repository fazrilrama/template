      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <!-- basic map -->
            <GoogleMap api-key="AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE" style="width: 100%; height: 300px" :center="{ lat: 2, lng: 2 }" :zoom="5">
            </GoogleMap>
          </BCardBody>
        </BCard>
      </BCol>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <GoogleMap api-key="AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE" style="width: 100%; height: 300px" :center="{ lat: 11, lng: 12 }" :zoom="3">
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <p class="card-title-dsec">Example of google maps.</p>
            <!-- Street view map -->
            <GoogleMap api-key="AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE" style="width: 100%; height: 300px" :center="center" :zoom="13">
            </GoogleMap>
          </BCardBody>
        </BCard>
      </BCol>
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <GoogleMap api-key="AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE" style="width: 100%; height: 300px" :center="center" :zoom="12">
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            ...
            <p class="card-title-dsec">Example of google maps.</p>
            <!-- Set map type -->
            <GoogleMap api-key="AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE" style="width: 100%; height: 300px" mapTypeId="terrain" :center="center" :zoom="3">
