...
<template>
  <Layout>
    ...
    <div class="table-responsive mb-0">
      <BTable table-class="table table-centered datatable table-card-list" BThead-tr-class="bg-transparent" :items="invoicelist" :fields="fields" responsive="sm" :per-page="perPage" :current-page="currentPage" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :filter="filter" :filter-included-fields="filterOn" @filtered="onFiltered">
